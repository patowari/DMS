...
class DocumentFileTaskTestCase(DocumentTestMixin, BaseTestCase):
    ...
    @staticmethod
    def _test_post_document_file_upload_callback(document_file, test_argument):
    ...
    def test_task_post_document_file_upload_callback(self, mocked_callback):
        ...
        task_document_file_upload.apply_async(
            kwargs={
                ...
                'callback_dotted_path': 'mayan.apps.documents.tests.test_document_file_tasks.DocumentFileTaskTestCase',
                'callback_function_name': '_test_post_document_file_upload_callback',
                'callback_kwargs': {

...
class StagingFolderSourceBackendDocumentUploadSourceMetadataTestCase(
    ...
    def test_basic(self):
        ...
        self.assertEqual(
            test_document_file.checksum, TEST_DOCUMENT_SMALL_CHECKSUM
        )

        self.assertEqual(test_document_file.source_metadata.count(), 1)

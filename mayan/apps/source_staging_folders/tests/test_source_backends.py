...
class StagingFolderSourceBackendActionDocumentFileUploadTestCase(
    StagingFolderSourceTestMixin, GenericDocumentTestCase
):
...
class StagingFolderSourceBackendActionDocumentUploadTestCase(
    StagingFolderSourceTestMixin, GenericDocumentTestCase
):
    _test_source_create_auto = False
...
class StagingFolderSourceBackendActionFileDeleteTestCase(
    StagingFolderSourceTestMixin, GenericDocumentTestCase
):
    _test_source_create_auto = False
    auto_upload_test_document = False
...
class StagingFolderSourceBackendActionFileImageTestCase(
    StagingFolderSourceTestMixin, GenericDocumentTestCase
):
    _test_source_create_auto = False
    auto_upload_test_document = False
...
class StagingFolderSourceBackendActionFileListTestCase(
    StagingFolderSourceTestMixin, GenericDocumentTestCase
):
    _test_source_create_auto = False
    auto_upload_test_document = False

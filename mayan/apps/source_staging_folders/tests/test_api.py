...
class StagingFolderSourceBackendAPIViewTestCase(
    DocumentTestMixin, SourceAPIViewTestMixin, StagingFolderSourceTestMixin,
    BaseAPITestCase
):
...
class StagingFolderSourceBackendActionDocumentFileUploadAPIViewTestCase(
    DocumentTestMixin, SourceActionAPIViewTestMixin,
    StagingFolderSourceTestMixin, BaseAPITestCase
):
    _test_source_create_auto = False
...
class StagingFolderSourceBackendActionDocumentUploadAPIViewTestCase(
    DocumentTestMixin, SourceActionAPIViewTestMixin,
    StagingFolderSourceTestMixin, BaseAPITestCase
):
    _test_source_create_auto = False
...
class StagingFolderSourceBackendActionDocumentUploadImmediateModeAPIViewTestCase(
    DocumentTestMixin, SourceActionAPIViewTestMixin,
    StagingFolderSourceTestMixin, BaseAPITestCase
):
    _test_source_create_auto = False
...
class StagingFolderSourceBackendActionFileDeleteAPIViewTestCase(
    DocumentTestMixin, SourceActionAPIViewTestMixin,
    StagingFolderSourceTestMixin, BaseAPITestCase
):
...
class StagingFolderSourceBackendActionFileImageAPIViewTestCase(
    DocumentTestMixin, SourceActionAPIViewTestMixin,
    StagingFolderSourceTestMixin, BaseAPITestCase
):
    auto_create_test_document_type = False
...
class StagingFolderSourceBackendActionFileListAPIViewTestCase(
    DocumentTestMixin, SourceActionAPIViewTestMixin,
    StagingFolderSourceTestMixin, BaseAPITestCase
):
    auto_create_test_document_type = False

...
worker_a = Worker(
    ...
    description=_(message='Low latency high volume tasks'), label=('Worker A'),
...
worker_d = Worker(
    ...
    description=_(message='Low latency, long lived tasks'), label=('Worker D'),
...
worker_e = Worker(
    ...
    description=_(message='Low latency, long lived tasks'), label=('Worker E'),

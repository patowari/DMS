...
worker_b = Worker(
    ...
    description=_('Medium latency tasks'), label=('Worker B'),
...
worker_c = Worker(
    ...
    description=_('Medium latency tasks'), label=('Worker C'),
...
worker_d = Worker(
    ...
    description=_('Low latency, long lived tasks'), label=('Worker D'),

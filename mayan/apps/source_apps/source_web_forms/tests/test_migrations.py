...
class SourceBackendPathMigrationTestCase(
    ...
    def prepare(self):
        ...
        self._create_test_source(
            backend_path='mayan.apps.source_apps.sources.source_backends.web_form_backends.SourceBackendWebForm'
        )
    ...
    def test_source_backend_path_updates(self):
        ...
        self.assertTrue(
            ...
            'mayan.apps.source_apps.source_web_forms.source_backends.SourceBackendWebForm'
        )

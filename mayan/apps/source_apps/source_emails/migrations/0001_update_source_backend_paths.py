...
SOURCE_BACKEND_MAPPING = {
    'mayan.apps.source_apps.sources.source_backends.email_backends.SourceBackendIMAPEmail': 'mayan.apps.source_apps.source_emails.source_backends.email_backends.SourceBackendIMAPEmail',
    'mayan.apps.source_apps.sources.source_backends.email_backends.SourceBackendPOP3Email': 'mayan.apps.source_apps.source_emails.source_backends.email_backends.SourceBackendPOP3Email',
}

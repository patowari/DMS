...
class SourceBackendPathMigrationTestCase(
    ...
    def test_source_backend_path_updates(self):
        ...
        self.assertTrue(
            ...
            'mayan.apps.source_apps.source_emails.source_backends.email_backends.SourceBackendIMAPEmail'
        )
        self.assertTrue(
...
class SourceBackendCredentialMigrationTestCase(
    ...
    def prepare(self):
        ...
        self._create_test_source(
            ...
            backend_path='mayan.apps.source_apps.source_emails.tests.email_backends.SourceBackendTestEmail'
        )

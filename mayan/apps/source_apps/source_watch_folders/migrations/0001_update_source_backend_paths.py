...
SOURCE_BACKEND_MAPPING = {
    'mayan.apps.source_apps.sources.source_backends.watch_folder_backends.SourceBackendWatchFolder': 'mayan.apps.source_apps.source_watch_folders.source_backends.SourceBackendWatchFolder'
}

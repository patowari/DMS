...
SOURCE_BACKEND_MAPPING = {
    'mayan.apps.source_apps.sources.source_backends.staging_folder_backends.SourceBackendStagingFolder': 'mayan.apps.source_apps.source_staging_folders.source_backends.staging_folder_backends.SourceBackendStagingFolder',
}

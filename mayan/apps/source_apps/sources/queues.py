...
queue_sources_periodic.add_task_type(
    ...
    dotted_path='mayan.apps.source_apps.sources.tasks.task_source_process_document'
)

queue_sources.add_task_type(
    label=_('Handle upload'),
    dotted_path='mayan.apps.source_apps.sources.tasks.task_process_document_upload'
)

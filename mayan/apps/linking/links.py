...
link_document_smart_link_instance_list = Link(
    ...
    permissions=(permission_document_view,), text=_(message='Smart links'),
...
link_document_type_smart_links = Link(
    ...
    permissions=(permission_document_type_edit,), text=_(message='Smart links'),
...
link_smart_link_document_types = Link(
    ...
    permissions=(permission_smart_link_edit,), text=_(message='Document types'),
    view='linking:smart_link_document_types'
)
link_smart_link_edit = Link(
    args='object.pk', icon=icon_smart_link_edit,
    permissions=(permission_smart_link_edit,), text=_(message='Edit'),
...
link_smart_link_instance_view = Link(
    ...
    permissions=(permission_smart_link_view,), text=_(message='Documents'),
...
link_smart_link_condition_create = Link(
    ...
    permissions=(permission_smart_link_edit,), text=_(message='Create condition'),
...
link_smart_link_condition_list = Link(
    ...
    permissions=(permission_smart_link_edit,), text=_(message='Conditions'),

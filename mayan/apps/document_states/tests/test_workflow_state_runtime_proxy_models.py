...
class WorkflowStateRuntimeProxyModelTestCase(
    ...
    def test_workflow_state_runtime_proxy_final_queryset_document_count_exclude(self):
        ...
        test_workflow_state_runtime_proxy = WorkflowStateRuntimeProxy.objects.get(
            pk=self._test_workflow_template_state.pk
        )

        test_document_count = test_workflow_state_runtime_proxy.get_document_count(
    ...
    def test_workflow_state_runtime_proxy_final_queryset_document_count_include(self):
        self._create_test_workflow_instance()
    ...
    def test_workflow_state_runtime_proxy_final_queryset_document_exclude(self):
        self._test_workflow_template.ignore_completed = True
        self._test_workflow_template.save()
        ...
        queryset = test_workflow_state_runtime_proxy.get_documents()
    ...
    def test_workflow_state_runtime_proxy_final_queryset_document_include(self):
        self._create_test_workflow_instance()

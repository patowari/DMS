...
TEST_DOCUMENT_EDIT_WORKFLOW_TEMPLATE_STATE_ACTION_TEMPLATE_LABEL = '{{ workflow_instance.document.label }} new'
TEST_DOCUMENT_EDIT_WORKFLOW_TEMPLATE_STATE_ACTION_TEMPLATE_DESCRIPTION = '{{ workflow_instance.document.label }}'
...
TEST_HEADERS_JSON_TEMPLATE_VALUE = '{{ workflow_instance.document.label }}'
...
TEST_PAYLOAD_TEMPLATE_DOCUMENT_LABEL = '{"label": "{{ workflow_instance.document.label }}"}'
...
TEST_WORKFLOW_TEMPLATE_STATE_ACTION_GENERIC_DOTTED_PATH = 'mayan.apps.document_states.tests.workflow_actions.WorkflowActionTest'
...
TEST_WORKFLOW_TEMPLATE_STATE_ESCALATION_UNIT = 'minutes'
TEST_WORKFLOW_TEMPLATE_STATE_ESCALATION_AMOUNT = 1
TEST_WORKFLOW_TEMPLATE_STATE_ESCALATION_AMOUNT_EDITED = 2

TEST_WORKFLOW_TEMPLATE_TRANSITION_FIELD_LOOKUP_CHOICE_LIST = ['1', '2', '3']

...
icon_group_delete_multiple = Icon(driver_name='fontawesome', symbol='times')
...
icon_user_delete_multiple = Icon(driver_name='fontawesome', symbol='times')
...
icon_user_set_password_multiple = Icon(

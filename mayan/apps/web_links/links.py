...
link_document_type_web_links = Link(
    ...
    permissions=(permission_document_type_edit,), text=_(message='Web links'),
...
link_document_web_link_list = Link(
    ...
    permissions=(permission_web_link_instance_view,), text=_(message='Web links'),
    view='web_links:document_web_link_list'
)
link_web_link_create = Link(
    icon=icon_web_link_create,
    permissions=(permission_web_link_create,), text=_(message='Create new web link'),
...
link_web_link_document_types = Link(
    ...
    permissions=(permission_web_link_edit,), text=_(message='Document types'),
    view='web_links:web_link_document_types'
)
link_web_link_edit = Link(
    args='object.pk', icon=icon_web_link_edit,
    permissions=(permission_web_link_edit,), text=_(message='Edit'),

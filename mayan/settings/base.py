...
INSTALLED_APPS = (
    ...
    'mayan.apps.source_apps.source_emails',
    'mayan.apps.source_apps.source_sane_scanners',
    'mayan.apps.source_apps.source_staging_folders',
    'mayan.apps.source_apps.source_staging_storages',
    'mayan.apps.source_apps.source_watch_folders',
    'mayan.apps.source_apps.source_watch_storages',
    'mayan.apps.source_apps.source_web_forms',
    'mayan.apps.source_apps.sources',
    'mayan.apps.tags',

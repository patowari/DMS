...
DOCKER_ELASTIC_IMAGE_TAG = '7.17.9'
DOCKER_KEYCLOAK_IMAGE_NAME = 'keycloak/keycloak'
DOCKER_KEYCLOAK_IMAGE_TAG = '20.0.1'
DOCKER_KEYCLOAK_POSTGRES_IMAGE_NAME = 'postgres'
DOCKER_KEYCLOAK_POSTGRES_IMAGE_TAG = '13.8-alpine'
DOCKER_LINUX_IMAGE_VERSION = 'debian:12.2-slim'
...
DOCKER_POSTGRESQL_IMAGE_TAG = '13.11-alpine'
DOCKER_PYTHON_IMAGE_VERSION = 'python:3.11.4-slim'
DOCKER_RABBITMQ_IMAGE_NAME = 'rabbitmq'
DOCKER_RABBITMQ_IMAGE_TAG = '3.12.2-management-alpine'
DOCKER_REDIS_IMAGE_NAME = 'redis'
DOCKER_REDIS_IMAGE_TAG = '7.0.12-alpine'

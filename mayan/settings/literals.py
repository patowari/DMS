...
DOCKER_POSTGRES_IMAGE_VERSION = 'postgres:13.10-alpine'
DOCKER_PYTHON_IMAGE_VERSION = 'python:3.10.11-slim'
DOCKER_RABBITMQ_IMAGE_VERSION = 'rabbitmq:3.11.13-alpine'
DOCKER_REDIS_IMAGE_VERSION = 'redis:7.0.10-alpine'

...
DOCKER_LINUX_IMAGE_VERSION = 'debian:11.7-slim'
DOCKER_MYSQL_IMAGE_VERSION = 'mysql:8.0.32'
DOCKER_ORACLE_IMAGE_VERSION = 'wnameless/oracle-xe-11g-r2'
DOCKER_POSTGRES_IMAGE_VERSION = 'postgres:12.14-alpine'
DOCKER_PYTHON_IMAGE_VERSION = 'python:3.10.11-slim'
DOCKER_RABBITMQ_IMAGE_VERSION = 'rabbitmq:3.10.20-alpine'
DOCKER_REDIS_IMAGE_VERSION = 'redis:6.2.12-alpine'

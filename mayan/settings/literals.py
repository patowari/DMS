...
DOCKER_ELASTIC_IMAGE_VERSION = 'elasticsearch:7.17.17'
DOCKER_KEYCLOAK_IMAGE_VERSION = 'keycloak/keycloak:20.0.5-0'
DOCKER_LINUX_IMAGE_VERSION = 'debian:12.4-slim'
DOCKER_MYSQL_IMAGE_VERSION = 'mysql:8.0.34'
DOCKER_ORACLE_IMAGE_VERSION = 'wnameless/oracle-xe-11g-r2'
DOCKER_POSTGRES_IMAGE_VERSION = 'postgres:13.13-alpine'
DOCKER_PYTHON_IMAGE_VERSION = 'python:3.11.7-slim'
DOCKER_RABBITMQ_IMAGE_VERSION = 'rabbitmq:3.12.12-alpine'
...
PYTHON_PSYCOPG2_VERSION_PREVIOUS = '2.9.6'

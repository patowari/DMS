...
DOCKER_DIND_IMAGE_VERSION = 'docker:27.4.1-dind-alpine3.21'
DOCKER_ELASTIC_IMAGE_NAME = 'elasticsearch'
DOCKER_ELASTIC_IMAGE_TAG = '7.17.26'
...
DOCKER_LINUX_IMAGE_VERSION = 'debian:12.8-slim'
...
DOCKER_POSTGRESQL_IMAGE_TAG = '14.15-alpine3.21'
DOCKER_POSTGRESQL_MAX_CONNECTIONS = 150
DOCKER_RABBITMQ_IMAGE_NAME = 'rabbitmq'
DOCKER_RABBITMQ_IMAGE_TAG = '4.0.5-management-alpine'
DOCKER_REDIS_IMAGE_NAME = 'redis'
DOCKER_REDIS_IMAGE_TAG = '7.4.1-alpine3.20'
DOCKER_TRAEFIK_IMAGE_NAME = 'traefik'
DOCKER_TRAEFIK_IMAGE_TAG = 'v2.11.16'
...
GUNICORN_WORKERS = 3
LINUX_PACKAGES_DEBIAN_BASE = 'ca-certificates clamav file ghostscript git gnupg1 graphviz libarchive-zip-perl libfile-mimeinfo-perl libfuse2 libimage-exiftool-perl libmariadb3 libpq5 libreoffice-calc-nogui libreoffice-draw-nogui libreoffice-impress-nogui libreoffice-math-nogui libreoffice-writer-nogui poppler-utils sane-utils sudo supervisor tesseract-ocr'
...
LINUX_PACKAGES_DEBIAN_DOCUMENTATION = 'enchant-2'
